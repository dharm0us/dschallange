...
def run(tdata,tlabels,vdata,vlabels,g,c,b):
    ...
    if(b<1):
        ...
        cw = {0: b}
    classifier = svm.SVC(gamma=g,C=c, kernel='rbf',class_weight=cw,probability=True) #higher C => Overfitting
...
tdata, tlabels = load_data('TrainSample.csv')
print("before")
print(tdata)
